...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int indicatorColor = getResources().getColor(R.color.color_red_da251c);// 0xFF0888ff;
    ...
    private int checkedTextColor = R.color.color_red_da251c;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        checkedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor, R.color.color_red_da251c);
