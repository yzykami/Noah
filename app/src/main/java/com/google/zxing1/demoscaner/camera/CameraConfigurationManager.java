...
package com.google.zxing1.demoscaner.camera;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mCameraResolution = findCloselySize(Utils.getScreenWidth(), Utils.getScreenHeight(),
                parameters.getSupportedPreviewSizes());
        Log.e(TAG, "Setting preview size: " + mCameraResolution.width + "-" + mCameraResolution.height);
        mPictureResolution = findCloselySize(Utils.getScreenWidth(), Utils.getScreenHeight(),
