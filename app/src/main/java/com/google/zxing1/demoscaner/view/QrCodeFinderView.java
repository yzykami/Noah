...
package com.google.zxing1.demoscaner.view;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mFrameRect.left = (Utils.getScreenWidth() - layoutParams.width) / 2;
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        float left = (Utils.getScreenWidth() - mPaint.getTextSize() * text.length()) / 2;
