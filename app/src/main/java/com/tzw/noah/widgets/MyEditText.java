...
public class MyEditText extends AppCompatEditText {
        ...
        public MyEditText(Context context, AttributeSet set)
        {
            super(context,set);
...
//            TypedArray typedArray = context.obtainStyledAttributes(set, R.styleable.CYTextView);
            ...
            float textsize = 23;//typedArray.getDimension(R.styleable.CYTextView_textSize, 34);
            int textcolor =0x666666;//typedArray.getColor(R.styleable.CYTextView_textColor, getResources().getColor(R.color.white));
            float linespace =15;// typedArray.getDimension(R.styleable.CYTextView_lineSpacingExtra, 15);
            int typeface = 0;//typedArray.getColor(R.styleable.CYTextView_typeface, 0);
...
//            canvas.setViewort(m_iTextWidth, m_iTextWidth);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
        {
            ...
            RelativeLayout.LayoutParams layout = new RelativeLayout.LayoutParams(measuredWidth,measuredHeight);
