...
public class ChatOtherBgView extends RelativeLayout {
    ...
    public ChatOtherBgView(Context context) {
        super(context);
    }

    public ChatOtherBgView(Context context, AttributeSet attr) {
        super(context, attr);
        ...
        border = radius / 2;
        stokeColor = getResources().getColor(R.color.bg_darkLight);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rect1 = new RectF(-1 * border, stokeWidth / 2, radius - border, radius);
        RectF rect2 = new RectF(itemWidth - radius - stokeWidth / 2, stokeWidth / 2, itemWidth - stokeWidth / 2, radius + stokeWidth / 2);
        RectF rect3 = new RectF(itemWidth - radius - stokeWidth / 2, itemHeight - radius - stokeWidth / 2, itemWidth - stokeWidth / 2, itemHeight - stokeWidth / 2);
        RectF rect4 = new RectF(border, itemHeight - radius - stokeWidth / 2, radius + border, itemHeight - stokeWidth / 2);
...
//        canvas.drawRoundRect(rect_round,radius,radius,stokePaint);
        ...
        path.lineTo(itemWidth - border, stokeWidth / 2);
        path.arcTo(rect2, 270, 90);
        path.lineTo(itemWidth - stokeWidth / 2, itemHeight - border);
        path.arcTo(rect3, 0, 90);
        path.lineTo(radius, itemHeight - stokeWidth / 2);
