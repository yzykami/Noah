...
package com.tzw.noah.widgets.swipeback;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        ...
        viewDragHelper = ViewDragHelper.create(this, 0.15f, new ViewDragHelperCallBack());
        chkDragable();
    }
    ...
    private void chkDragable() {
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                com.tzw.noah.logger.Log.log("aaa", " , move_action = " + motionEvent.getAction() + " , offsetX = " + offsetX + ",offsetY = " + offsetY);
                return false;
            }
        });
    }
    ...
    public void setEnablePullToBack(boolean b) {
        ...
        com.tzw.noah.logger.Log.log("aaa", "enablePullToBack:" + enablePullToBack);
    }
    ...
    private void finish() {
        ...
        act.finish();
        act.overridePendingTransition(0, R.anim.swipeback_exit);
    }
