package com.tzw.noah.widgets.listener;
 ...
 */
public abstract class SimpleClickListener<T extends RecyclerView.Adapter> implements RecyclerView.OnItemTouchListener {
...
//                mPressedView.setPressed(true);
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            if (mIsPrepressed && mPressedView != null) {
                ...
                AssemblyRecyclerItem vh = (AssemblyRecyclerItem) recyclerView.getChildViewHolder(pressedView);

//                if (isHeaderOrFooterPosition(vh.getLayoutPosition())) {
//                    return false;
//                }
//                childClickViewIds = vh.getItemView();
//
...
////                    onItemClick(baseAdapter, pressedView, vh.getLayoutPosition() - baseAdapter.getHeaderLayoutCount());
//                }
                setPressViewHotSpot(e, vh.getItemView());
