    ...
    public static int StatusBarLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightMode(activity, true)) {
                ...
                if (activity instanceof StatusBarProvider) {
                    View statusBar = ((StatusBarProvider) activity).getStatusBar();
                    if (statusBar != null)
                        statusBar.setBackgroundColor(activity.getResources().getColor(R.color.black));
                }
