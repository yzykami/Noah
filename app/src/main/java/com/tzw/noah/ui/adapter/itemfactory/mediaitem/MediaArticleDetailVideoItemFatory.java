...
public class MediaArticleDetailVideoItemFatory extends AssemblyRecyclerItemFactory<MediaArticleDetailVideoItemFatory.GalleryItem> {

    private MediaArticleDetailListener mMediaListListener;
    private int itemSize;

    public MediaArticleDetailVideoItemFatory(MediaArticleDetailListener mMediaListListener) {
