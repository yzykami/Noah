package com.tzw.noah.ui.home.scan;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(activity.getHandler(), com.vondear.rxtools.R.id.decode_succeeded, rawResult);
            ...
            Log.d(TAG, "Sending decode false message...");
            if (activity.getHandler() != null) {
                Message message = Message.obtain(activity.getHandler(), com.vondear.rxtools.R.id.decode_failed);
                message.sendToTarget();
            }
        }
    }
