...
import com.tzw.noah.ui.home.GalleryImageFragment;
...
public class ImageFragmentItemFactory2 extends AssemblyFragmentItemFactory<Image> {
    ...
    public ImageFragmentItemFactory2(Context context, String loadingImageOptionsId) {
...
//            }
//        });
        GalleryImageFragment fragment = GalleryImageFragment.newInstance(image.regularUrl);
        fragment.setImageClickListener(new GalleryImageFragment.ImageClickListener() {
            @Override
            public void onImageClick() {
                if (mImageClickListener != null)
                    mImageClickListener.onImageClick();
